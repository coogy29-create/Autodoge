...
local function getBarrierFolder()
	local core = workspace:FindFirstChild("Core__Game")
	if core then
		local mapRoot = core:FindFirstChild("Map")
		if mapRoot then
			local mapModel = mapRoot:FindFirstChild("Map")
			if mapModel then
				local barriers = mapModel:FindFirstChild("Barriers")
				if barriers then
					return barriers
				end
			end

			local directBarriers = mapRoot:FindFirstChild("Barriers")
			if directBarriers then
				return directBarriers
			end
		end
	end
	...
	if mapRoot then
		...
		return mapRoot:FindFirstChild("Barriers")
	end
...
local function getBarrierParams()
	local barriers = getBarrierFolder()
