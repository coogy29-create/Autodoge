...
local function chooseDirection(character, humanoid, root, knownOnly)
		...
		if LEARNING_MODE then
			...
			if healthRatio < LEARNING_MIN_HEALTH_RATIO then
				local emergencyDirection, risk, impactTime =
					chooseDirection(character, humanoid, root, false)
			...
			local knownDirection, knownRisk, knownImpact =
				chooseDirection(character, humanoid, root, true)
