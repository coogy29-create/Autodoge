...
local SPACE_PATH_STEPS = {1.8, 3.5, 5.5, 7.0}
local SPACE_LOSS_WEIGHT = 75
local SPACE_CORNER_WEIGHT = 95
local SPACE_HARD_PENALTY = 1200
local SPACE_ESCAPE_BONUS = 34
...
local function evaluateSpacePath(root, humanoid, direction, threatCount)
	...
	for _, travel in ipairs(SPACE_PATH_STEPS) do
		local future =
			root.Position
			+ unit * travel * magnitude
